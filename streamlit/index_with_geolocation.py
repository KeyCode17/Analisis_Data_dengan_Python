...
customer = pd.read_csv(os.path.abspath("dataset_streamlit/customers_dataset.csv"))
geolocation = pd.read_csv(os.path.abspath("dataset_streamlit/geolocation_dataset.csv"))
